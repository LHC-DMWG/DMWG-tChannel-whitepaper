...
\begin{document}
\title{\begin{boldmath} \huge LHC Dark Matter Working Group:  \\ Recommendations for models with $t$-channel production of Dark Matter \vspace{7mm} \end{boldmath}}

%%%%%%

\author[1]{First~Last,}
\affiliation[1]{Department/Institute, University/Lab, \\
address}

\affiliation[*]{DMWG organisers}

\hfill CERN-LPCC-2019-00X

\abstract{To be filled \ldots}  
